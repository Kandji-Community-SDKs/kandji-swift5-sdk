...
open class BlueprintsAPI {
     ...
     */
    @discardableResult
    open class func createBlueprint(name: String, enrollmentCodeIsActive: String, enrollmentCodeCode: String, sourceType: String, sourceId: String, type: String, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: AnyCodable?, _ error: Error?) -> Void)) -> RequestTask {
     ...
     */
    @discardableResult
    open class func updateBlueprint(blueprintId: String, name: String, description: String, enrollmentCodeCode: String, enrollmentCodeIsActive: String, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: AnyCodable?, _ error: Error?) -> Void)) -> RequestTask {
        return updateBlueprintWithRequestBuilder(blueprintId: blueprintId, name: name, description: description, enrollmentCodeCode: enrollmentCodeCode, enrollmentCodeIsActive: enrollmentCodeIsActive).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    url: https://api-docs.kandji.io/#4820ba50-291a-4857-b622-77a9ab9cc9e3
     ...
     - returns: RequestBuilder<AnyCodable> 
     */
    open class func updateBlueprintWithRequestBuilder(blueprintId: String, name: String, description: String, enrollmentCodeCode: String, enrollmentCodeIsActive: String) -> RequestBuilder<AnyCodable> {
        var localVariablePath = "/api/v1/blueprints/{blueprint_id}"
        let blueprintIdPreEscape = "\(APIHelper.mapValueToPathItem(blueprintId))"
        let blueprintIdPostEscape = blueprintIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{blueprint_id}", with: blueprintIdPostEscape, options: .literal, range: nil)
