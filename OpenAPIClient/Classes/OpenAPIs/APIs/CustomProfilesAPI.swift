...
open class CustomProfilesAPI {
     ...
     */
    @discardableResult
    open class func createCustomProfile(name: String, file: URL, active: String, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: AnyCodable?, _ error: Error?) -> Void)) -> RequestTask {
