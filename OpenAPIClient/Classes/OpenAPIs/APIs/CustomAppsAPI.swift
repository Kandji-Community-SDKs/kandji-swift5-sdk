...
open class CustomAppsAPI {
     ...
     */
    @discardableResult
    open class func updateCustomApp(libraryItemId: String, name: String, active: String, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: AnyCodable?, _ error: Error?) -> Void)) -> RequestTask {
